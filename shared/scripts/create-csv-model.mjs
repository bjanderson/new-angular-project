...
// ------------------------------------
const modelTemplate = `import { getObject, getString, isNullOrEmpty, toKabob } from '@bjanderson/utils';
import { ICSVModel } from 'src/interfaces';

export class PascalCase implements ICSVModel {
  public name: string;
  ...
  constructor(o?: Partial<PascalCase>) {
    ...
    this.name = getString(obj.name, null);
  }

  static parse(text: string): PascalCase {
    const obj = JSON.parse(text);
    return new PascalCase(obj);
  }
